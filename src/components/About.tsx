      ...
      <div className="grid md:grid-cols-2 gap-16 items-start">
        ...
        <div className="flex flex-col gap-6">
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="w-full rounded-2xl p-6 bg-gradient-to-r from-[var(--color-cyan)] to-[#a855f7] flex items-center justify-between group cursor-pointer hover:shadow-[0_0_30px_rgba(79,209,197,0.4)] transition-all mt-2"
          >
