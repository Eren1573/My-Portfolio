    ...
    <section id="experience" className="py-8 px-8 md:px-24 relative z-10 flex flex-col justify-center min-h-[80vh]">
      <div className="max-w-6xl mx-auto w-full">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-20 mt-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl leading-tight font-display font-bold tracking-tight bg-[linear-gradient(to_right,var(--color-cyan),var(--color-purple-light),var(--color-cyan),var(--color-purple-light))] bg-[length:200%_auto] animate-gradient text-transparent bg-clip-text pb-1 px-4">
              B. Sai Naga Sowri
            </h1>
          </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          >
            ...
            <h3 className="text-2xl md:text-3xl font-display font-bold text-[var(--color-text-main)] mb-4">40+</h3>
          ...
          >
            ...
            <h3 className="text-2xl md:text-3xl font-display font-bold text-[var(--color-text-main)] mb-4">6+</h3>
            <p className="text-[var(--color-text-dim)] text-sm tracking-wide leading-relaxed">
          ...
          <motion.div 
            ...
            className="glass-card p-10 flex flex-col items-center text-center justify-center transition-all hover:bg-[var(--color-cyan-dimmer)] group cursor-pointer"
          >
            <a 
            ...
            >
              ...
              <p className="text-[var(--color-text-dim)] text-sm tracking-wide leading-relaxed group-hover:text-[var(--color-text-main)] transition-colors">
